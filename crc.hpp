...
void append_CRC8_check_sum(unsigned char* pch_message, unsigned int dw_length) {
    ...
    ucCRC = get_CRC8_check_sum(static_cast<unsigned char*>(pch_message), dw_length - 1, CRC8_INIT);
...
void append_CRC16_check_sum(uint8_t* pchMessage, uint32_t dwLength) {
    ...
    wCRC = get_CRC16_check_sum(static_cast<uint8_t*>(pchMessage), dwLength - 2, CRC16_INIT);
